...
| --- | --- | --- | --- |
| `2.3.2` | `3.x` | `17+` (tested on `17`, `21`, and `25`) | Supported and tested |
| `2.3.2` | `2.x` | Not applicable | Unsupported |
| `2.3.2` | `4.x` | Not tested | Not officially supported |
...
```groovy
implementation "io.github.mavencrafted:scheduled-audit-autoconfigure:2.3.2"
